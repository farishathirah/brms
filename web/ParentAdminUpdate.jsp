...
<html>
    ...
    <body>
        ...
        <h4 style="color: white; text-align: left; margin: 10px; position: absolute; top: 10px; left: 10px;">
            <a href="EmployerSignIn.jsp" style="text-decoration: none; color: white;"><- Back</a>
        </h4>
        <header>
        ...
        <div class="container">
            ...
            <main>
                <div class="intro">
                    <div class="content">
                        <c:if test ="${parent!=null}">
                            <form action="ParentServlet" method="post" onsubmit="return validateForm();">
                                <input type="hidden" name="action" value="pupdateprofile">
                            </c:if>
                            <c:if test="${parent== null}">
                                <form action="ParentServlet" method="post" onsubmit="return validateForm();">

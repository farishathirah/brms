...
<html>
    <head>
        ...
        <title>Admin - Parent Details</title>
    ...
    <body>
        <header>
            ...
            <a href="ParentSignIn.jsp" class="logout" style="float: right;">LogOut</a>
        ...
        <div class="intro">
            <div class="content">
                    ...
                    <tbody>
                        ...
                        <c:forEach var="parent" items="${listParent}">
                            <tr>
                                ...
                                <td><c:out value="${parent.parentUser}"/></td>

                                <td><c:out value="${parent.parentPass}"/></td>
                                ...
                                <td>
                                    <a href="ParentServlet?action=peditadmin&parentID=<c:out value='${parent.parentID}'/>">
                                        <i class="fas fa-edit" style="color: green;"></i>
                                    </a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;

                                    <a href="#" onclick="showConfirmationPopup('<c:out value='${parent.parentID}'/>')">
                ...
                <div class="popup-container" id="confirmationPopup">
                    <div class="popup-content">
                        ...
                        <div class="popup-buttons">
                            <form id="deleteForm" method="post" action="ParentServlet?action=pdelete">
                ...
                <script>
                    function showConfirmationPopup(parentID) {
